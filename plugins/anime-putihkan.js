...
let handler = async (m, { conn, args, usedPrefix, command }) => {
  ...
  let defaultPrompt = "Ubahlah Karakter Dari Gambar Tersebut agar berkulit putih";
  ...
  try {
    ...
    if (resultImage) {
      ...
      m.reply("Gagal jirr, kulitnya udh putih :v");
    }
  } catch (error) {
    console.error(error);
