let handler = async (m, { conn, command }) => {
  ...
  try {
    ...
    if (command == 'neko') {
      const res = `https://api.vreden.web.id/api/neko`;
      await conn.sendFile(m.chat, res, 'neko.jpg', '', m);
    }
    if (command == 'orgy') {
...
handler.command = handler.help = ['gay','ahegao','ass','bdsm','blowjob','cuckold','cum','ero','femdom','foot','gangbang','glasses','hentai','gifs','jahy','manga','masturbation','neko2','neko','orgy','tentacles','pussy','panties','thighs','yuri','zettai']
