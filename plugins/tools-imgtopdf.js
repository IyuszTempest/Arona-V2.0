...
let handler = async (m, { conn, usedPrefix, command }) => {
    ...
    if (!mime.startsWith('image/')) {
        return conn.reply(m.chat, `Reply gambar dengan caption *${usedPrefix + command}* untuk diubah menjadi PDF!`, fkontak);
    }
    ...
    try {
        ...
        const apiUrl = `https://api.lolhuman.xyz/api/convert/imgtopdf?apikey=${global.lolkey}&img=${encodeURIComponent(imageUrl)}`;
        ...
        await conn.sendMessage(m.chat, {
            ...
            caption: '✅ Gambar berhasil diubah menjadi PDF!'
        }, { quoted: fkontak });
